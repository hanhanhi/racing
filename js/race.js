...
// var carTimer = true ,roadRepeat = true, scoreTimer;//要停止的setTimeout
// var endTime = -5;
//
...
//         $(".RaceSpace").animate({'backgroundPositionY':'-100px'}, 1000, 'linear', function(){});//賽道變慢
...
//         // for(var i = 1; i <= 10; i++){
//         $('.car').stop(true,false);
//         $(".car").animate({"marginTop" : "150%"}, 400,"linear", function() { });
//         // }
//         roadRepeat = false;
//         endLine.stop(true,false);
//         endLine.animate({'bottom':'110%'}, 500,'linear', function(){});
...
//     var speedUp = Math.floor(Math.random() * 1000 + 600);
//     return speedUp;
// }
//
